package com.baseframe.core.widget.swiperefresh;
 ...
 * description: 重写官方SwipeRefreshLayout 加入上拉加载更多
 */
public class SwipeRefreshLayout extends ViewGroup {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() > 0) {
            getChildAt(0).measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth() - getPaddingLeft() - getPaddingRight(), View.MeasureSpec.EXACTLY),
                    View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() - getPaddingTop() - getPaddingBottom(), View.MeasureSpec.EXACTLY));
        }
    }
    ...
    public void setMode(Mode mode) {
        this.mMode = mode;
        setColor(android.R.color.holo_blue_bright, android.R.color.holo_green_light, android.R.color.holo_orange_light, android.R.color.holo_red_light);
    }
